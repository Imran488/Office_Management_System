...
include 'connection.php';
  if(isset($_POST['submit'])){
	  ...
	  $sql ="select * from manager_login where user = '".$uname."'  and password ='".$pass."'";
...
<center>
 ...
 <table class="tab1">
   ...
   <tr>
     <td  style="text-align:center;height:60px;background-color:white;color:black;font-size:20px;font-family: 'Righteous', cursive;padding:0px">Manager Login</td>
    </tr>
